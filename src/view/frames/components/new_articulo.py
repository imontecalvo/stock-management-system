...
class NewArticulo():
    def __init__(self, parent):
        ...
        supplier, supplier_var=self.menu_input(curr_row+2,"Proveedor")
        brand, brand_var=self.menu_input(curr_row+3,"Marca")
        type, type_var=self.menu_input(curr_row+4,"Tipo")
    ...
    def menu_input(self, row, label):
        ...
        customtkinter.CTkButton(self.modal, text="+", corner_radius=5, anchor="center", height=20, width=20, font=('_',13)).grid(row=row, column=3, pady=7, padx=(0,10), sticky='e')
